"""
Django settings for BookLoop project.
...
DEBUG = True
ALLOWED_HOSTS = ["localhost","0.0.0.0","bookloop-s6np.onrender.com","127.0.0.1"]
CSRF_TRUSTED_ORIGINS = ['https://bookloop-s6np.onrender.com','http://0.0.0.0:8000','http://localhost:8000','http://127.0.0.1:8000']
